...
Para contextualizar a inovação do NautiGo, é possível observar que aplicativos de transporte terrestre, como Uber, 99 e Lyft, consolidaram mundialmente o modelo de mobilidade sob demanda. Esses sistemas demonstraram que a combinação de geolocalização, solicitação digital de corridas e pagamento integrado pode transformar profundamente a forma como pessoas se locomovem em ambientes urbanos. 

No entanto, tais soluções permanecem restritas ao transporte terrestre e não atendem às demandas específicas de regiões costeiras, ribeirinhas ou ilhas, onde o deslocamento por embarcações é essencial. Assim, o NautiGo se destaca por aplicar esse modelo comprovadamente eficiente ao contexto aquático, onde ainda não existe uma plataforma abrangente com essa proposta.
...
- Expansão do modelo para regiões pouco atendidas por soluções tecnológicas, ampliando o acesso ao transporte seguro.
...
1. **Sistema de pagamentos integrado:**
   1. **Justificativa:** A possibilidade de pagar por meios digitais facilita as transações e evita a necessidade de dinheiro físico.

1. **Sistema de avaliações e _feedback_:**
...
|**Necessidade:** Sistema de avaliações e _feedback_||
| :- | :- |
|**Funcionalidade**|**Categoria**|
...
1. **Conectividade com a internet**
   1. O funcionamento do aplicativo depende de acesso à internet para solicitação de viagens, rastreamento de embarcações e processamento de pagamentos.

1. **Dispositivos compatíveis**
   1. O software será desenvolvido para Web, sem suporte inicial para desktop ou versões mobile.
